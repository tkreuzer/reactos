...
/*0x018*/     FUNCT_006E_2255_ServiceRoutine* ServiceRoutine;
/*0x020*/     FUNCT_006E_225A_MessageServiceRoutine* MessageServiceRoutine;
...
/*0x050*/     FUNCT_00AE_0282_PostProcessInitRoutine_DispatchAddress_FinishRoutine* DispatchAddress;
...
/*0x040*/         struct _MMVAD_FLAGS2 VadFlags2;              // 6 elements, 0x4 bytes (sizeof)
              }u2;
              union                                            // 2 elements, 0x8 bytes (sizeof)
              {
...
/*0x000*/     ULONG32      Spare : 14;           // 17 BitPosition
...
/*0x000*/     ULONG32      Spare : 4;       // 28 BitPosition
...
/*0x028*/         struct _MMVAD_FLAGS VadFlags;      // 8 elements, 0x4 bytes (sizeof)
              }u;
              union                                  // 2 elements, 0x4 bytes (sizeof)
              {
...
/*0x030*/     FUNCT_00AE_115E_DumpProcedure* DumpProcedure;
/*0x038*/     FUNCT_0064_1166_OpenProcedure* OpenProcedure;
/*0x040*/     FUNCT_00AE_1174_CloseProcedure* CloseProcedure;
/*0x048*/     FUNCT_00AE_0744_Free_IdleExecute_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DeleteProcedure;
/*0x050*/     FUNCT_0064_117A_ParseProcedure* ParseProcedure;
/*0x058*/     FUNCT_0064_1186_SecurityProcedure* SecurityProcedure;
/*0x060*/     FUNCT_0064_1197_QueryNameProcedure* QueryNameProcedure;
/*0x068*/     FUNCT_006E_119F_OkayToCloseProcedure* OkayToCloseProcedure;
...
/*0x003*/         UINT8        ImageSigningLevel : 3;      // 1 BitPosition
/*0x003*/         UINT8        Spare : 4;                  // 4 BitPosition
              };
