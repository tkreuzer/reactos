...
#define INFO_MASK_TO_OFFSET(Mask) \
    (((Mask) & CREATOR_INFO_MASK) ? sizeof(OBJECT_HEADER_CREATOR_INFO) : 0 + \
     ((Mask) & NAME_INFO_MASK) ? sizeof(OBJECT_HEADER_NAME_INFO) : 0 + \
     ((Mask) & PROCESS_INFO_MASK) ? sizeof(OBJECT_HEADER_PROCESS_INFO) : 0 + \
     ((Mask) & QUOTA_INFO_MASK) ? sizeof(OBJECT_HEADER_QUOTA_INFO) : 0 + \
     ((Mask) & HANDLE_INFO_MASK) ? sizeof(OBJECT_HEADER_HANDLE_INFO) : 0)

const UCHAR ObpInfoMaskToOffset[MAX_INFO_MASK + 1] =
{
    INFO_MASK_TO_OFFSET(0x00), INFO_MASK_TO_OFFSET(0x01), INFO_MASK_TO_OFFSET(0x02), INFO_MASK_TO_OFFSET(0x03),
    INFO_MASK_TO_OFFSET(0x04), INFO_MASK_TO_OFFSET(0x05), INFO_MASK_TO_OFFSET(0x06), INFO_MASK_TO_OFFSET(0x07),
    INFO_MASK_TO_OFFSET(0x08), INFO_MASK_TO_OFFSET(0x09), INFO_MASK_TO_OFFSET(0x0A), INFO_MASK_TO_OFFSET(0x0B),
    INFO_MASK_TO_OFFSET(0x0C), INFO_MASK_TO_OFFSET(0x0D), INFO_MASK_TO_OFFSET(0x0E), INFO_MASK_TO_OFFSET(0x0F),
    INFO_MASK_TO_OFFSET(0x10), INFO_MASK_TO_OFFSET(0x11), INFO_MASK_TO_OFFSET(0x12), INFO_MASK_TO_OFFSET(0x13),
    INFO_MASK_TO_OFFSET(0x14), INFO_MASK_TO_OFFSET(0x15), INFO_MASK_TO_OFFSET(0x16), INFO_MASK_TO_OFFSET(0x17),
    INFO_MASK_TO_OFFSET(0x18), INFO_MASK_TO_OFFSET(0x19), INFO_MASK_TO_OFFSET(0x1A), INFO_MASK_TO_OFFSET(0x1B),
    INFO_MASK_TO_OFFSET(0x1C), INFO_MASK_TO_OFFSET(0x1D), INFO_MASK_TO_OFFSET(0x1E), INFO_MASK_TO_OFFSET(0x1F)
}
