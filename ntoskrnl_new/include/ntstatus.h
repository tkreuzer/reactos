...
#define NTSTATUS MYNTSTATUS
#define PNTSTATUS PMYNTSTATUS
...
#define __NTSTATUS_FROM_WIN32(x) \
    ((NTSTATUS)(x) <= 0 ? ((NTSTATUS)(x)) : \
     ((NTSTATUS) (((x) & 0x0000FFFF) | (FACILITY_NTWIN32 << 16) | ERROR_SEVERITY_ERROR)))

#if defined(INLINE_NTSTATUS_FROM_WIN32) && !defined(__midl)
__inline
NTSTATUS_FROM_WIN32(long x)
{
