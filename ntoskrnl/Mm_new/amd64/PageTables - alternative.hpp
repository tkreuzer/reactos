...
typedef struct _HARDWARE_PTE
{
    ...
    PteActive = 0,           // 0b00
    PteActivePageTable = 1,  // 0b01
    PteActiveShared = 2,     // 0b10
    PteActiveDemandZero = 3, // 0b11

    PteSoftPageFile = 4,     // 0b00
    PteSoftPrototype = 5,    // 0b01
    PteSoftTransition = 6,   // 0b10
    PteSoftVAD = 7,          // 0b11
...
public:
    ...
    CreateValidKernelPde (
        _In_ PFN_NUMBER PageFrameNumber)
    {
        return CreateValidKernelPte(PageFrameNumber);
    }
