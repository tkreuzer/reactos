...
#if DBG
    RtlFillMemory(Allocation, NumberOfBytes, POOL_UNINIT_FILLER);
#endif
...
#if DBG
        RtlFillMemory(P, PageCount * PAGE_SIZE, POOL_FREED_FILLER);
#endif
...
#if DBG
    RtlFillMemory(P, BlockSize * POOL_BLOCK_SIZE - sizeof(*Entry), POOL_FREED_FILLER);
#endif
