...
/* Old style macros */
#define __null                          _Null_
#define __notnull                       _Notnull_
#define __maybenull                     _Maybenull_
#define __valid                         _Valid_
#define __notvalid                      _Notvalid_
#define __maybevalid                    _Maybevalid_
