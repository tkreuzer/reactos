 ...
 * PURPOSE:          Generic C Implementation of arc cosine
...
/*
 * The arc cosine can be approximated with the following row:
 *
 *   acos(x) = a0*x + a1*x^3 + a2*x^5 + a3*x^7 + a4*x^9 + ...
 *
 * To reduce the number of multiplications the formula is transormed to
 *
 *   acos(x) = x * (1 + x^2*(a1 + x^2*(a2 + x^2*(a3 + ...) ) ) )
 *
