...
} g_exception_Testcases[] =
{
    ...
    { OP_ZeroDivide, ~_EM_ZERODIVIDE, _SW_ZERODIVIDE, STATUS_FLOAT_DIVIDE_BY_ZERO, ON_IX86(0x3800) ON_AMD64(0xfd84) ON_ARM(0) },
    { OP_ZeroDivide, ~_MCW_EM, _SW_ZERODIVIDE, STATUS_FLOAT_DIVIDE_BY_ZERO, ON_IX86(0x3800) ON_AMD64(0xe104) ON_ARM(0) },
