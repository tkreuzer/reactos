...
ReturnAddress:
    ...
    // Zero out the context (this does not clobber any registers)
    call ZeroContext
    ...
    mov rax, [rsp + ExP3Home]
    mov [rcx + CxRcx], rax

    // Save the returned EFLags in the context    
    mov rax, [rsp + ExP4Home]
    mov [rcx + CxEFlags], rax
