...
//#undef ok
//#define ok(x, ...) do { if (!(x)) __debugbreak(); } while(0)
...
//static
void test_ExtTextOutScale(void)
{
...
static const unsigned char MF_PATTERN_BRUSH_BITS[] = {
    ...
    0x00, 0x03, // mtVersion
    0x3d, 0x00, 0x00, 0x00, // mtSize
    0x01, 0x00, // mtNoObjects
    0x2d, 0x00, 0x00, 0x00, // mtMaxRecord
    0x00, 0x00, // mtNoParameters

    0x2d, 0x00, 0x00, 0x00, // rdSize
    0x42, 0x01, // rdFunction: META_DIBCREATEPATTERNBRUSH
    0x03, 0x00, // logbrush.lbStyle;
    0x00, 0x00, // usage
    0x28, 0x00, 0x00, 0x00, // biSize
    0x08, 0x00, 0x00, 0x00, // biWidth
    0x08, 0x00, 0x00, 0x00, // biHeight
    0x01, 0x00, // biPlanes
    0x01, 0x00, // biBitCount
    0x00, 0x00, 0x00, 0x00, // biCompression
    0x20, 0x00, 0x00, 0x00, // biSizeImage
...
static const unsigned char EMF_BITBLT[] =
{
    ...
    0x4c, 0x00, 0x00, 0x00, 0xbc, 0x00, 0x00, 0x00, // emr
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // rclBounds
    0x03, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // xDest, yDest
    0x04, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, // cxDest, cyDest
    0x20, 0x00, 0xcc, 0x00, 0x00, 0x00, 0x00, 0x00, // dwRop, xSrc
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x3f, // ySrc, xformSrc
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // xformSrc
    0x00, 0x00, 0x80, 0x3f, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0x00, // xformSrc, crBkColorSrc
    0x00, 0x00, 0x00, 0x00, 0x64, 0x00, 0x00, 0x00, // iUsageSrc, offBmiSrc
    0x28, 0x00, 0x00, 0x00, 0x8c, 0x00, 0x00, 0x00, // cbBmiSrc, offBitsSrc
    0x30, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00, // cbBitsSrc, bmi.
    0x04, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00,
    0x01, 0x00, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // xxx, bits
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static const unsigned char EMF_DCBRUSH_BITS[] =
{
    ...
    // SelectObject(hdcMetafile, GetStockObject(DC_BRUSH));
    // EMR_SELECTOBJECT
    0x25, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00,
    0x12, 0x00, 0x00, 0x80,

    // SelectObject(hdcMetafile, GetStockObject(DC_PEN));
    // EMR_SELECTOBJECT
    0x25, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00,
    0x13, 0x00, 0x00, 0x80,

    // SetDCBrushColor( hdcMetafile, RGB(0x55,0x55,0x55) );
    // EMR_CREATEBRUSHINDIRECT
    0x27, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00,
    0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    // pSetDCPenColor( hdcMetafile, RGB(0x33,0x44,0x55) );
    // EMR_CREATEPEN
    ...
    // SetDCBrushColor( hdcMetafile, RGB(0x12,0x34,0x56) );
    // EMR_DELETEOBJECT
