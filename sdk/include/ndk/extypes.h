...
typedef enum _SYSTEM_INFORMATION_CLASS
{
    ...
    SystemVerifierAddDriverInformation = 40 /*0x28*/, // NT 3.51-4.0: SystemPlugPlayBusInformation
    SystemVerifierRemoveDriverInformation = 41 /*0x29*/, // 3.51 to 4.0: SystemDockInformation
    SystemProcessorIdleInformation = 42 /*0x2A*/, // 3.51 to 5.0: SystemPowerInformationNative
    SystemLegacyDriverInformation = 43 /*0x2B*/, // 3.51 to 4.0: SystemProcessorSpeedInformation
    ...
    SystemVerifierThunkExtend = 52 /*0x34*/, // obsolete: SystemAddVerifier?
    SystemSessionProcessInformation = 53 /*0x35*/,
    SystemSessionProcessesInformation = SystemSessionProcessInformation,
    SystemLoadGdiDriverInSystemSpace = 54 /*0x36*/,
    SystemLoadGdiDriverInSystemSpaceInformation = SystemLoadGdiDriverInSystemSpace,
    ...
    SystemWatchdogTimerHandler = 71 /*0x47*/, // ROS: SystemWatchDogTimerHandler
    SystemWatchdogTimerInformation = 72 /*0x48*/, // ROS: SystemWatchDogTimerInformation
    ...
    SystemPrefetchPatchInformation = 96 /*0x60*/, // ROS: SystemPrefetchPathInformation
    ...
    SystemPolicyInformation = 134 /*0x86*/,
    ...
    SystemCriticalProcessErrorLogInformation = 142 /*0x8E*/,
    ...
    SystemVsmProtectionInformation = 169 /*0xA9*/,
    ...
    SystemDifPoolTrackingInformation = 226 /*0xE2*/,
...
// https://github.com/zodiacon/WindowsInternals/blob/a96df1435733da1efcefbc3166e97fb4abfd9956/MemInfo/MemInfo.h
