...
/* KPROCESS */
C_ASSERT_FIELD(KPROCESS, 0x000, DISPATCHER_HEADER, Header)
C_ASSERT_FIELD(KPROCESS, 0x010, LIST_ENTRY, ProfileListHead)
C_ASSERT_FIELD(KPROCESS, 0x018, ULONG64, DirectoryTableBase)
C_ASSERT_FIELD(KPROCESS, 0x020, KGDTENTRY, LdtDescriptor)
C_ASSERT_FIELD(KPROCESS, 0x028, KIDTENTRY, Int21Descriptor)
C_ASSERT_FIELD(KPROCESS, 0x030, USHORT, IopmOffset)
C_ASSERT_FIELD(KPROCESS, 0x032, UCHAR, Iopl)
C_ASSERT_FIELD(KPROCESS, 0x033, UCHAR, Unused)
C_ASSERT_FIELD(KPROCESS, 0x034, ULONG, ActiveProcessors)
C_ASSERT_FIELD(KPROCESS, 0x038, ULONG, KernelTime)
C_ASSERT_FIELD(KPROCESS, 0x03C, ULONG, UserTime)
C_ASSERT_FIELD(KPROCESS, 0x040, LIST_ENTRY, ReadyListHead)
C_ASSERT_FIELD(KPROCESS, 0x048, SINGLE_LIST_ENTRY, SwapListEntry)
C_ASSERT_FIELD(KPROCESS, 0x04C, PVOID, VdmTrapcHandler)
C_ASSERT_FIELD(KPROCESS, 0x050, LIST_ENTRY, ThreadListHead)
C_ASSERT_FIELD(KPROCESS, 0x058, ULONG, ProcessLock)
C_ASSERT_FIELD(KPROCESS, 0x05C, KAFFINITY, Affinity)
#if (NTDDI_VERSION < NTDDI_WS02SP1)
C_ASSERT_FIELD(KPROCESS, 0x060, USHORT, StackCount)
C_ASSERT_FIELD(KPROCESS, 0x062, CHAR, BasePriority)
C_ASSERT_FIELD(KPROCESS, 0x063, CHAR, ThreadQuantum)
C_ASSERT_FIELD(KPROCESS, 0x064, UCHAR, AutoAlignment)
C_ASSERT_FIELD(KPROCESS, 0x065, UCHAR, State)
C_ASSERT_FIELD(KPROCESS, 0x066, UCHAR, ThreadSeed)
C_ASSERT_FIELD(KPROCESS, 0x067, UCHAR, DisableBoost)
C_ASSERT_FIELD(KPROCESS, 0x068, UCHAR, PowerState)
C_ASSERT_FIELD(KPROCESS, 0x069, UCHAR, DisableQuantum)
C_ASSERT_FIELD(KPROCESS, 0x06A, UCHAR, IdealNode)
C_ASSERT_FIELD(KPROCESS, 0x06B, UCHAR, Spare)
#else
C_ASSERT_FIELD(KPROCESS, 0x060, LONG, ProcessFlags)
C_ASSERT_FIELD(KPROCESS, 0x064, CHAR, BasePriority)
C_ASSERT_FIELD(KPROCESS, 0x065, CHAR, QuantumReset)
C_ASSERT_FIELD(KPROCESS, 0x066, UCHAR, State)
C_ASSERT_FIELD(KPROCESS, 0x067, UCHAR, ThreadSeed)
C_ASSERT_FIELD(KPROCESS, 0x068, UCHAR, PowerState)
C_ASSERT_FIELD(KPROCESS, 0x069, UCHAR, IdealNode)
C_ASSERT_FIELD(KPROCESS, 0x06A, UCHAR, Visited)
C_ASSERT_FIELD(KPROCESS, 0x06B, KEXECUTE_OPTIONS, Flags)
C_ASSERT_FIELD(KPROCESS, 0x06B, UCHAR, ExecuteOptions)
C_ASSERT_FIELD(KPROCESS, 0x06C, ULONG, StackCount)
C_ASSERT_FIELD(KPROCESS, 0x070, LIST_ENTRY, ProcessListEntry)
#endif
