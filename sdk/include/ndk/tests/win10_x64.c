...
C_ASSERT_FIELD(TEB32, 0xf64, ULONG, EtwLocalData)
...
C_ASSERT_FIELD(TEB32, 0xf8c, ULONG, SoftPatchPtr1)
...
C_ASSERT_FIELD(TEB32, 0xfa8, ULONG, HeapVirtualAffinity)
...
C_ASSERT_FIELD(TEB32, 0xfc8, ULONG, CrossTebFlags)
