...
//extern __m128i _mm_set1_epi64x(long long __q); // FIXME
...
extern void _mm_maskmoveu_si128(__m128i __d, __m128i __n, _Out_writes_bytes_(16) char *__p);
...
{
    return (__m128i)builtin_ia32_cvttpd2dq((__v2df)a);
}

__INTRIN_INLINE_SSE2 int _mm_cvttsd_si32(__m128d a)
{
    return builtin_ia32_cvttsd2si((__v2df)a);
}

__INTRIN_INLINE_SSE2 __m64 __DEFAULT_FN_ATTRS_MMX _mm_cvtpd_pi32(__m128d a)
{
    return (__m64)builtin_ia32_cvtpd2pi((__v2df)a);
}

__INTRIN_INLINE_SSE2 __m64 __DEFAULT_FN_ATTRS_MMX _mm_cvttpd_pi32(__m128d a)
{
    return (__m64)builtin_ia32_cvttpd2pi((__v2df)a);
}

__INTRIN_INLINE_SSE2 __m128d __DEFAULT_FN_ATTRS_MMX _mm_cvtpi32_pd(__m64 a)
{
    return builtin_ia32_cvtpi2pd((__v2si)a);
}
...
__INTRIN_INLINE_SSE2 __m128d _mm_load_pd(double const *__dp)
{
    return *(const __m128d *)__dp;
}

__INTRIN_INLINE_SSE2 __m128d _mm_load1_pd(double const *__dp)
{
    struct __mm_load1_pd_struct {
      double __u;
    } attribute__((__packed__, __may_alias__));
...
__INTRIN_INLINE_SSE2 __m128d _mm_loadr_pd(double const *__dp)
{
    __m128d __u = *(const __m128d *)__dp;
    return builtin_shufflevector((__v2df)__u, (__v2df)__u, 1, 0);
}

__INTRIN_INLINE_SSE2 __m128d _mm_loadu_pd(double const *__dp)
{
    struct __loadu_pd {
      __m128d_u __v;
    } attribute__((__packed__, __may_alias__));
...
__INTRIN_INLINE_SSE2 __m128d _mm_load_sd(double const *__dp)
{
...
{
    return (__m128d)builtin_ia32_undef128();
}

__INTRIN_INLINE_SSE2 __m128d _mm_set_sd(double __w)
{
    return __extension__(__m128d){__w, 0};
}

__INTRIN_INLINE_SSE2 __m128d _mm_set1_pd(double __w)
{
    return __extension__(__m128d){__w, __w};
}

__INTRIN_INLINE_SSE2 __m128d _mm_set_pd1(double __w)
{
    return _mm_set1_pd(__w);
}

__INTRIN_INLINE_SSE2 __m128d _mm_set_pd(double __w,
                                                          double __x)
{
    return __extension__(__m128d){__x, __w};
}

__INTRIN_INLINE_SSE2 __m128d _mm_setr_pd(double __w,
                                                           double __x)
{
...
__INTRIN_INLINE_SSE2 void _mm_store_sd(double *__dp, __m128d a)
{
    struct __mm_store_sd_struct {
      double __u;
    } attribute__((__packed__, __may_alias__));
    ((struct __mm_store_sd_struct *)__dp)->__u = a[0];
}

__INTRIN_INLINE_SSE2 void _mm_store_pd(double *__dp, __m128d a)
{
    *(__m128d *)__dp = a;
}

__INTRIN_INLINE_SSE2 void _mm_store1_pd(double *__dp, __m128d a)
{
    a = builtin_shufflevector((__v2df)a, (__v2df)a, 0, 0);
    _mm_store_pd(__dp, a);
}

__INTRIN_INLINE_SSE2 void _mm_store_pd1(double *__dp, __m128d a)
{
    _mm_store1_pd(__dp, a);
}

__INTRIN_INLINE_SSE2 void _mm_storeu_pd(double *__dp, __m128d a)
{
    struct __storeu_pd {
      __m128d_u __v;
    } attribute__((__packed__, __may_alias__));
    ((struct __storeu_pd *)__dp)->__v = a;
}

__INTRIN_INLINE_SSE2 void _mm_storer_pd(double *__dp, __m128d a)
{
    a = builtin_shufflevector((__v2df)a, (__v2df)a, 1, 0);
    *(__m128d *)__dp = a;
}

__INTRIN_INLINE_SSE2 void _mm_storeh_pd(double *__dp, __m128d a)
{
    struct __mm_storeh_pd_struct {
      double __u;
    } attribute__((__packed__, __may_alias__));
    ((struct __mm_storeh_pd_struct *)__dp)->__u = a[1];
}

__INTRIN_INLINE_SSE2 void _mm_storel_pd(double *__dp, __m128d a)
{
    struct __mm_storeh_pd_struct {
      double __u;
    } attribute__((__packed__, __may_alias__));
    ((struct __mm_storeh_pd_struct *)__dp)->__u = a[0];
}
...
__INTRIN_INLINE_SSE2 __m64 __DEFAULT_FN_ATTRS_MMX _mm_add_si64(__m64 a, __m64 b)
{
    return (__m64)builtin_ia32_paddq((__v1di)a, (__v1di)b);
}
...
{
    return (__m128i)builtin_elementwise_add_sat((__v16qs)a, (__v16qs)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_adds_epi16(__m128i a, __m128i b)
{
    return (__m128i)builtin_elementwise_add_sat((__v8hi)a, (__v8hi)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_adds_epu8(__m128i a, __m128i b)
{
    return (__m128i)builtin_elementwise_add_sat((__v16qu)a, (__v16qu)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_adds_epu16(__m128i a, __m128i b)
{
    return (__m128i)builtin_elementwise_add_sat((__v8hu)a, (__v8hu)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_avg_epu8(__m128i a, __m128i b)
{
    return (__m128i)builtin_ia32_pavgb128((__v16qi)a, (__v16qi)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_avg_epu16(__m128i a, __m128i b)
{
    return (__m128i)builtin_ia32_pavgw128((__v8hi)a, (__v8hi)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_madd_epi16(__m128i a, __m128i b)
{
    return (__m128i)builtin_ia32_pmaddwd128((__v8hi)a, (__v8hi)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_max_epi16(__m128i a, __m128i b)
{
    return (__m128i)builtin_elementwise_max((__v8hi)a, (__v8hi)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_max_epu8(__m128i a, __m128i b)
{
    return (__m128i)builtin_elementwise_max((__v16qu)a, (__v16qu)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_min_epi16(__m128i a, __m128i b)
{
    return (__m128i)builtin_elementwise_min((__v8hi)a, (__v8hi)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_min_epu8(__m128i a, __m128i b)
{
    return (__m128i)builtin_elementwise_min((__v16qu)a, (__v16qu)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_mulhi_epi16(__m128i a, __m128i b)
{
    return (__m128i)builtin_ia32_pmulhw128((__v8hi)a, (__v8hi)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_mulhi_epu16(__m128i a, __m128i b)
{
    return (__m128i)builtin_ia32_pmulhuw128((__v8hi)a, (__v8hi)b);
}
...
__INTRIN_INLINE_SSE2 __m64 __DEFAULT_FN_ATTRS_MMX _mm_mul_su32(__m64 a, __m64 b)
{
    return builtin_ia32_pmuludq((__v2si)a, (__v2si)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_mul_epu32(__m128i a, __m128i b)
{
    return builtin_ia32_pmuludq128((__v4si)a, (__v4si)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_sad_epu8(__m128i a, __m128i b)
{
    return builtin_ia32_psadbw128((__v16qi)a, (__v16qi)b);
}
...
__INTRIN_INLINE_SSE2 __m64 __DEFAULT_FN_ATTRS_MMX _mm_sub_si64(__m64 a, __m64 b)
{
    return (__m64)builtin_ia32_psubq((__v1di)a, (__v1di)b);
}
...
{
    return (__m128i)builtin_elementwise_sub_sat((__v16qs)a, (__v16qs)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_subs_epi16(__m128i a, __m128i b)
{
    return (__m128i)builtin_elementwise_sub_sat((__v8hi)a, (__v8hi)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_subs_epu8(__m128i a, __m128i b)
{
    return (__m128i)builtin_elementwise_sub_sat((__v16qu)a, (__v16qu)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_subs_epu16(__m128i a, __m128i b)
{
    return (__m128i)builtin_elementwise_sub_sat((__v8hu)a, (__v8hu)b);
}
...
#define _mm_slli_si128(a, imm)                                                 \
    ((__m128i)builtin_ia32_pslldqi128_byteshift((__v2di)(__m128i)(a),          \
                                                  (int)(imm)))
...
__INTRIN_INLINE_SSE2 __m128i _mm_slli_epi16(__m128i a,
                                                              int __count)
{
    return (__m128i)builtin_ia32_psllwi128((__v8hi)a, __count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_sll_epi16(__m128i a, __m128i __count)
{
    return (__m128i)builtin_ia32_psllw128((__v8hi)a, (__v8hi)__count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_slli_epi32(__m128i a,
                                                              int __count)
{
    return (__m128i)builtin_ia32_pslldi128((__v4si)a, __count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_sll_epi32(__m128i a, __m128i __count)
{
    return (__m128i)builtin_ia32_pslld128((__v4si)a, (__v4si)__count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_slli_epi64(__m128i a,
                                                              int __count)
{
    return builtin_ia32_psllqi128((__v2di)a, __count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_sll_epi64(__m128i a, __m128i __count)
{
    return builtin_ia32_psllq128((__v2di)a, (__v2di)__count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_srai_epi16(__m128i a,
                                                              int __count)
{
    return (__m128i)builtin_ia32_psrawi128((__v8hi)a, __count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_sra_epi16(__m128i a, __m128i __count)
{
    return (__m128i)builtin_ia32_psraw128((__v8hi)a, (__v8hi)__count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_srai_epi32(__m128i a,
                                                              int __count)
{
    return (__m128i)builtin_ia32_psradi128((__v4si)a, __count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_sra_epi32(__m128i a, __m128i __count)
{
    return (__m128i)builtin_ia32_psrad128((__v4si)a, (__v4si)__count);
}

#define _mm_srli_si128(a, imm)                                                 \
    ((__m128i)builtin_ia32_psrldqi128_byteshift((__v2di)(__m128i)(a),          \
                                                  (int)(imm)))
...
__INTRIN_INLINE_SSE2 __m128i _mm_srli_epi16(__m128i a,
                                                              int __count)
{
    return (__m128i)builtin_ia32_psrlwi128((__v8hi)a, __count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_srl_epi16(__m128i a, __m128i __count)
{
    return (__m128i)builtin_ia32_psrlw128((__v8hi)a, (__v8hi)__count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_srli_epi32(__m128i a,
                                                              int __count)
{
    return (__m128i)builtin_ia32_psrldi128((__v4si)a, __count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_srl_epi32(__m128i a, __m128i __count)
{
    return (__m128i)builtin_ia32_psrld128((__v4si)a, (__v4si)__count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_srli_epi64(__m128i a,
                                                              int __count)
{
    return builtin_ia32_psrlqi128((__v2di)a, __count);
}

__INTRIN_INLINE_SSE2 __m128i _mm_srl_epi64(__m128i a, __m128i __count)
{
    return builtin_ia32_psrlq128((__v2di)a, (__v2di)__count);
}
...
__INTRIN_INLINE_SSE2 __m128d _mm_cvtsi64_sd(__m128d a,
                                                              long long b)
{
    a[0] = b;
    return a;
...
{
    return builtin_ia32_cvtsd2si64((__v2df)a);
}

__INTRIN_INLINE_SSE2 long long _mm_cvttsd_si64(__m128d a)
{
    return builtin_ia32_cvttsd2si64((__v2df)a);
}
#endif

__INTRIN_INLINE_SSE2 __m128 _mm_cvtepi32_ps(__m128i a)
{
    return (__m128) builtin_convertvector((__v4si)a, __v4sf);
}

__INTRIN_INLINE_SSE2 __m128i _mm_cvtps_epi32(__m128 a)
{
    return (__m128i)builtin_ia32_cvtps2dq((__v4sf)a);
}

__INTRIN_INLINE_SSE2 __m128i _mm_cvttps_epi32(__m128 a)
{
    return (__m128i)builtin_ia32_cvttps2dq((__v4sf)a);
}
...
__INTRIN_INLINE_SSE2 __m128i __DEFAULT_FN_ATTRS
...
{
    return (__m128i)builtin_ia32_undef128();
}

__INTRIN_INLINE_SSE2 __m128i _mm_set_epi64x(long long __q1,
                                                              long long __q0)
{
    return __extension__(__m128i)(__v2di){__q0, __q1};
}

__INTRIN_INLINE_SSE2 __m128i _mm_set_epi64(__m64 __q1, __m64 __q0)
{
    return _mm_set_epi64x((long long)__q1, (long long)__q0);
}

__INTRIN_INLINE_SSE2 __m128i _mm_set_epi32(int __i3, int __i2,
                                                             int __i1, int __i0)
{
...
__INTRIN_INLINE_SSE2 __m128i __DEFAULT_FN_ATTRS
_mm_set_epi8(char b15, char b14, char b13, char b12, char b11,
...
__INTRIN_INLINE_SSE2 __m128i _mm_set1_epi64x(long long __q)
{
    return _mm_set_epi64x(__q, __q);
}

__INTRIN_INLINE_SSE2 __m128i _mm_set1_epi64(__m64 __q)
{
    return _mm_set_epi64(__q, __q);
}

__INTRIN_INLINE_SSE2 __m128i _mm_set1_epi32(int __i)
{
    return _mm_set_epi32(__i, __i, __i, __i);
}

__INTRIN_INLINE_SSE2 __m128i _mm_set1_epi16(short __w)
{
...
__INTRIN_INLINE_SSE2 __m128i _mm_setr_epi64(__m64 __q0, __m64 __q1)
{
    return _mm_set_epi64(__q1, __q0);
}

__INTRIN_INLINE_SSE2 __m128i _mm_setr_epi32(int __i0, int __i1,
                                                              int __i2,
                                                              int __i3)
{
...
__INTRIN_INLINE_SSE2 __m128i __DEFAULT_FN_ATTRS
_mm_setr_epi8(char b0, char b1, char b2, char b3, char b4, char b5,
                char b6, char b7, char b8, char b9, char b10,
...
__INTRIN_INLINE_SSE2 void _mm_store_si128(__m128i *__p, __m128i b)
{
    *__p = b;
}

__INTRIN_INLINE_SSE2 void _mm_storeu_si128(__m128i_u *__p, __m128i b)
{
    struct __storeu_si128 {
      __m128i_u __v;
    } attribute__((__packed__, __may_alias__));
    ((struct __storeu_si128 *)__p)->__v = b;
}

__INTRIN_INLINE_SSE2 void _mm_storeu_si64(void *__p, __m128i b)
{
    struct __storeu_si64 {
      long long __v;
    } attribute__((__packed__, __may_alias__));
    ((struct __storeu_si64 *)__p)->__v = ((__v2di)b)[0];
}

__INTRIN_INLINE_SSE2 void _mm_storeu_si32(void *__p, __m128i b)
{
    struct __storeu_si32 {
      int __v;
    } attribute__((__packed__, __may_alias__));
    ((struct __storeu_si32 *)__p)->__v = ((__v4si)b)[0];
}

__INTRIN_INLINE_SSE2 void _mm_storeu_si16(void *__p, __m128i b)
{
    struct __storeu_si16 {
      short __v;
    } attribute__((__packed__, __may_alias__));
    ((struct __storeu_si16 *)__p)->__v = ((__v8hi)b)[0];
}

__INTRIN_INLINE_SSE2 void _mm_maskmoveu_si128(__m128i __d, __m128i __n,
                                                                char *__p)
{
    builtin_ia32_maskmovdqu((__v16qi)__d, (__v16qi)__n, __p);
}

__INTRIN_INLINE_SSE2 void _mm_storel_epi64(__m128i_u *__p, __m128i a)
{
    struct __mm_storel_epi64_struct {
      long long __u;
    } attribute__((__packed__, __may_alias__));
    ((struct __mm_storel_epi64_struct *)__p)->__u = a[0];
}

__INTRIN_INLINE_SSE2 void _mm_stream_pd(double *__p, __m128d a)
{
    builtin_nontemporal_store((__v2df)a, (__v2df *)__p);
}

__INTRIN_INLINE_SSE2 void _mm_stream_si128(__m128i *__p, __m128i a)
{
    builtin_nontemporal_store((__v2di)a, (__v2di *)__p);
}

__INTRIN_INLINE_SSE2 void
      attribute__((always_inline__, __nodebug__, __target__("sse2")))
      _mm_stream_si32(int *__p, int a)
{
    builtin_ia32_movnti(__p, a);
}
...
__INTRIN_INLINE_SSE2 void
      attribute__((always_inline__, __nodebug__, __target__("sse2")))
      _mm_stream_si64(long long *__p, long long a)
{
    builtin_ia32_movnti64(__p, a);
}
#endif
...
{
    return (__m128i)builtin_ia32_packsswb128((__v8hi)a, (__v8hi)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_packs_epi32(__m128i a, __m128i b)
{
    return (__m128i)builtin_ia32_packssdw128((__v4si)a, (__v4si)b);
}

__INTRIN_INLINE_SSE2 __m128i _mm_packus_epi16(__m128i a, __m128i b)
{
    return (__m128i)builtin_ia32_packuswb128((__v8hi)a, (__v8hi)b);
}

#define _mm_extract_epi16(a, imm)                                              \
    ((int)(unsigned short)builtin_ia32_vec_ext_v8hi((__v8hi)(__m128i)(a),      \
                                                      (int)(imm)))

#define _mm_insert_epi16(a, b, imm)                                            \
    ((__m128i)builtin_ia32_vec_set_v8hi((__v8hi)(__m128i)(a), (int)(b),        \
                                          (int)(imm)))

__INTRIN_INLINE_SSE2 int _mm_movemask_epi8(__m128i a)
{
    return builtin_ia32_pmovmskb128((__v16qi)a);
}

#define _mm_shuffle_epi32(a, imm)                                              \
    ((__m128i)builtin_ia32_pshufd((__v4si)(__m128i)(a), (int)(imm)))

#define _mm_shufflelo_epi16(a, imm)                                            \
    ((__m128i)builtin_ia32_pshuflw((__v8hi)(__m128i)(a), (int)(imm)))

#define _mm_shufflehi_epi16(a, imm)                                            \
    ((__m128i)builtin_ia32_pshufhw((__v8hi)(__m128i)(a), (int)(imm)))

__INTRIN_INLINE_SSE2 __m128i _mm_unpackhi_epi8(__m128i a, __m128i b)
{
    return (__m128i)builtin_shufflevector(
...
{
    return (__m128i)builtin_shufflevector((__v8hi)a, (__v8hi)b, 4, 8 + 4, 5,
                                            8 + 5, 6, 8 + 6, 7, 8 + 7);
}

__INTRIN_INLINE_SSE2 __m128i _mm_unpackhi_epi32(__m128i a, __m128i b)
{
    return (__m128i)builtin_shufflevector((__v4si)a, (__v4si)b, 2, 4 + 2, 3,
                                            4 + 3);
}

__INTRIN_INLINE_SSE2 __m128i _mm_unpackhi_epi64(__m128i a, __m128i b)
{
    return (__m128i)builtin_shufflevector((__v2di)a, (__v2di)b, 1, 2 + 1);
}
...
{
    return (__m128i)builtin_shufflevector((__v8hi)a, (__v8hi)b, 0, 8 + 0, 1,
                                            8 + 1, 2, 8 + 2, 3, 8 + 3);
}

__INTRIN_INLINE_SSE2 __m128i _mm_unpacklo_epi32(__m128i a, __m128i b)
{
    return (__m128i)builtin_shufflevector((__v4si)a, (__v4si)b, 0, 4 + 0, 1,
                                            4 + 1);
}

__INTRIN_INLINE_SSE2 __m128i _mm_unpacklo_epi64(__m128i a, __m128i b)
{
    return (__m128i)builtin_shufflevector((__v2di)a, (__v2di)b, 0, 2 + 0);
}
...
{
    return builtin_shufflevector((__v2di)a, _mm_setzero_si128(), 0, 2);
}

__INTRIN_INLINE_SSE2 __m128d _mm_unpackhi_pd(__m128d a, __m128d b)
{
    return builtin_shufflevector((__v2df)a, (__v2df)b, 1, 2 + 1);
}

__INTRIN_INLINE_SSE2 __m128d _mm_unpacklo_pd(__m128d a, __m128d b)
{
    return builtin_shufflevector((__v2df)a, (__v2df)b, 0, 2 + 0);
}

__INTRIN_INLINE_SSE2 int _mm_movemask_pd(__m128d a)
{
    return builtin_ia32_movmskpd((__v2df)a);
}

#define _mm_shuffle_pd(a, b, i)                                                \
    ((__m128d)builtin_ia32_shufpd((__v2df)(__m128d)(a), (__v2df)(__m128d)(b),  \
                                    (int)(i)))
