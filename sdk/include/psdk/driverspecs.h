...
#define _Landmark_(name)                            _SAL_L_Source_(_Landmark_, (name), _SA_annotes1(SAL_landmark, #name))
#define __drv_acquiresCancelSpinLock                _SAL1_Source_(__drv_acquiresCancelSpinLock, (kind), _Acquires_nonreentrant_lock_(_Global_cancel_spin_lock_))
#define __drv_acquiresCriticalRegion                _SAL1_Source_(__drv_acquiresCriticalRegion, (kind), _Acquires_lock_(_Global_critical_region_))
#define __drv_acquiresExclusiveResource(kind)       _SAL1_1_Source_(__drv_acquiresExclusiveResource, (kind), _Acquires_nonreentrant_lock_(_Curr_))
#define __drv_acquiresExclusiveResourceGlobal(kind,param)   _SAL1_Source_(__drv_acquiresExclusiveResourceGlobal, (kind), _Acquires_nonreentrant_lock_(param))
#define __drv_acquiresPriorityRegion                _SAL1_Source_(__drv_acquiresPrioorityRegion, (kind), _Acquires_lock_(_Global_priority_region_))
...
#define __drv_holdsCancelSpinLock()                 _SAL1_Source_(__drv_holdsCanselSpinLock, (kind), _Holds_resource_global_("CancelSpinLock",))
#define __drv_holdsCriticalRegion()                 _SAL1_Source_(__drv_holdsCriticalRegion, (kind), _Holds_resource_global_("CriticalRegion",))
#define __drv_holdsPriorityRegion()                 _SAL1_Source_(__drv_holdsPriorityRegion, (kind), _Holds_resource_global_("PriorityRegion",))
...
#define __drv_mustHoldCancelSpinLock                _SAL1_Source_(__drv_mustHoldCancelSpinLock, (kind), _Requires_lock_held_(_Global_cancel_spin_lock_))
#define __drv_mustHoldCriticalRegion                _SAL1_Source_(__drv_mustHoldCriticalRegion, (kind), _Requires_lock_held_(_Global_critical_region_))
#define __drv_mustHoldGlobal(kind,param)            _SAL1_1_Source_(__drv_mustHoldGlobal, (kind, param), _Requires_lock_held_(param))
#define __drv_mustHoldPriorityRegion                _SAL1_Source_(__drv_mustHoldPriorityRegion, (kind), _Requires_lock_held_(_Global_priority_region_))
...
#define __drv_neverHoldCancelSpinLock               _SAL1_Source_(__drv_neverHoldCancelSpinLock, (kind), _Requires_lock_not_held_(_Global_cancel_spin_lock_))
#define __drv_neverHoldCriticalRegion               _SAL1_Source_(__drv_neverHoldCriticalRegion, (kind), _Requires_lock_not_held_(_Global_critical_region_))
#define __drv_neverHoldGlobal(kind,param)           _SAL1_1_Source_(__drv_neverHoldGlobal, (kind, param), _Requires_lock_not_held_(param))
#define __drv_neverHoldPriorityRegion               _SAL1_Source_(__drv_neverHoldPriorityRegion, (kind), _Requires_lock_not_held_(_Global_priority_region_))
...
#define __drv_releasesCancelSpinLock                _SAL1_Source_(__drv_releasesCancelSpinLock, (kind), _Releases_nonreentrant_lock_(_Global_cancel_spin_lock_))
#define __drv_releasesCriticalRegion                _SAL1_Source_(__drv_releasesCriticalRegion, (kind), _Releases_lock_(_Global_critical_region_))
#define __drv_releasesExclusiveResource(kind)       _SAL1_Source_(__drv_releasesExclusiveResource, (kind), _Releases_nonreentrant_lock_(_Curr_))
#define __drv_releasesExclusiveResourceGlobal(kind, param) _SAL1_Source_(__drv_releasesExclusiveResourceGlobal, (kind), _Releases_nonreentrant_lock_(param))
#define __drv_releasesPriorityRegion                _SAL1_Source_(__drv_releasesPriorityRegion, (kind), _Releases_lock_(_Global_priority_region_))
