...
#if 0
"|ENCLS|ENCLS[EADD]|ENCLS[EAUG]|ENCLS[EBLOCK]|ENCLS[ECREATE]|ENCLS[EDBGRD]|ENCLS[EDBGWR]|ENCLS[EEXTEND]|ENCLS[EINIT]|ENCLS[ELBUC]|ENCLS[ELDBC]|ENCLS[ELDB]|ENCLS[ELDU]|ENCLS[EMODPR]|ENCLS[EMODT]|ENCLS[EPA]|ENCLS[ERDINFO]|ENCLS[EREMOVE]|ENCLS[ETRACKC]|ENCLS[ETRACK]|ENCLS[EWB]|ENCLU|" \
"ENCLU[EACCEPTCOPY]|ENCLU[EACCEPT]|ENCLU[EENTER]|ENCLU[EEXIT]|ENCLU[EGETKEY]|ENCLU[EMODPE]|ENCLU[EREPORT]|ENCLU[ERESUME]|ENCLV|ENCLV[EDECVIRTCHILD]|ENCLV[EINCVIRTCHILD]|ENCLV[ESETCONTEXT]|SMX Instructions"
"GETSEC[CAPABILITIES]|GETSEC[ENTERACCS]|GETSEC[EXITAC]|GETSEC[PARAMETERS]|GETSEC[SENTER]|GETSEC[SEXIT]|GETSEC[SMCTRL]|GETSEC[WAKEUP]"
"INVEPT|INVVPID|VMCALL|VMCLEAR|VMFUNC|VMLAUNCH|VMPTRLD|VMPTRST|VMREAD|VMRESUME|VMWRITE|VMXOFF|VMXON|"
"PREFETCHWT1|V4FMADDPS|V4FMADDSS|V4FNMADDPS|V4FNMADDSS|VEXP2PD|VEXP2PS|VGATHERPF0DPD|VGATHERPF0DPS|VGATHERPF0QPD|VGATHERPF0QPS|VGATHERPF1DPD|VGATHERPF1DPS|VGATHERPF1QPD|VGATHERPF1QPS|VP4DPWSSD|VP4DPWSSDS|VRCP28PD|VRCP28PS|VRCP28SD|VRCP28SS|VRSQRT28PD|VRSQRT28PS|VRSQRT28SD|VRSQRT28SS|" \
"VSCATTERPF0DPD|VSCATTERPF0DPS|VSCATTERPF0QPD|VSCATTERPF0QPS|VSCATTERPF1DPD|VSCATTERPF1DPS|VSCATTERPF1QPD|VSCATTERPF1QPS|"
#endif

std::vector<TOKEN_DEF> g_TokenList =
{
...
translate_identifier_construct(TokenList& tokens, size_t index, const vector<string> &macro_params)
{
    ...
    switch (tok2.type())
    {
        ...
        default:
            // We don't know what it is, assume it's a macro and trat it like an instruction
