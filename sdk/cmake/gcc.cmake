...
if(ARCH STREQUAL "i386")
    set(HAS_NATIVE_SEH 0)
    set(USE_PSEH3 1)
else()
    set(HAS_NATIVE_SEH 1)
endif()
...
elseif(HAS_NATIVE_PSEH)
    add_definitions(-D_USE_NATIVE_SEH=1)
else()
    message(ERROR "SEH configuration error.")
endif()
...
# Warnings, errors
if((NOT CMAKE_BUILD_TYPE STREQUAL "Release") AND (NOT CMAKE_C_COMPILER_ID STREQUAL Clang) AND (ARCH STREQUAL "i386"))
