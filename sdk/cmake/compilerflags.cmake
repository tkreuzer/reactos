...
macro(replace_link_flags _oldflags _newflags)
    if(NOT ${ARGC} EQUAL 2)
        message(FATAL_ERROR "Wrong arguments to replace_compile_flags! Args ${ARGN}")
    endif()
    foreach(_buildtype DEBUG RELWITHDEBINFO RELEASE MINSIZEREL)
        replace_compiler_option(CMAKE_EXE_LINKER_FLAGS_${_buildtype} ${_oldflags} ${_newflags})
        replace_compiler_option(CMAKE_SHARED_LINKER_FLAGS_${_buildtype} ${_oldflags} ${_newflags})
    endforeach()
endmacro()
