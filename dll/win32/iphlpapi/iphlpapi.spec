...
@ stdcall -arch=i386 _PfAddFiltersToInterface@24()
@ stdcall -arch=i386 _PfAddGlobalFilterToInterface@8()
@ stdcall -arch=i386 _PfBindInterfaceToIPAddress@12()
@ stdcall -arch=i386 _PfBindInterfaceToIndex@16()
@ stdcall -arch=i386 _PfCreateInterface@24()
@ stdcall -arch=i386 _PfDeleteInterface@4()
@ stdcall -arch=i386 _PfDeleteLog@0()
@ stdcall -arch=i386 _PfGetInterfaceStatistics@16()
@ stdcall -arch=i386 _PfMakeLog@4()
@ stdcall -arch=i386 _PfRebindFilters@8()
@ stdcall -arch=i386 _PfRemoveFilterHandles@12()
@ stdcall -arch=i386 _PfRemoveFiltersFromInterface@20()
@ stdcall -arch=i386 _PfRemoveGlobalFilterFromInterface@8()
@ stdcall -arch=i386 _PfSetLogBuffer@28()
@ stdcall -arch=i386 _PfTestPacket@20()
@ stdcall -arch=i386 _PfUnBindInterface@4()
