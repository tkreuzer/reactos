...
@ stdcall -arch=win64 WSCDeinstallProvider32(ptr ptr)
@ stdcall WSCEnableNSProvider(ptr long)
@ stdcall -arch=win64 WSCEnableNSProvider32(ptr long)
@ stdcall -arch=win64 WSCEnumNameSpaceProviders32(ptr ptr)
@ stdcall -stub -version=0x600+ -arch=win64 WSCEnumNameSpaceProvidersEx32(ptr ptr)
@ stdcall WSCEnumProtocols(ptr ptr ptr ptr)
@ stdcall -arch=win64 WSCEnumProtocols32(ptr ptr ptr ptr)
...
@ stdcall -arch=win64 WSCGetProviderPath32(ptr ptr ptr ptr)
@ stdcall WSCInstallNameSpace(wstr wstr long long ptr)
@ stdcall -arch=win64 WSCInstallNameSpace32(wstr wstr long long ptr)
...
@ stdcall -arch=win64 WSCInstallProvider64_32(ptr wstr ptr long ptr)
...
@ stdcall -arch=win64 WSCUnInstallNameSpace32(ptr)
@ stdcall WSCUpdateProvider(ptr wstr ptr long ptr)
@ stdcall -arch=win64 WSCUpdateProvider32(ptr wstr ptr long ptr)
@ stdcall WSCWriteNameSpaceOrder(ptr long)
@ stdcall -arch=win64 WSCWriteNameSpaceOrder32(ptr long)
@ stdcall WSCWriteProviderOrder(ptr long)
@ stdcall -arch=win64 WSCWriteProviderOrder32(ptr long)
