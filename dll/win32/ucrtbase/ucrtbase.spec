...
@ cdecl _CrtCheckMemory() # FIXME: params
@ cdecl _CrtDbgReport() # FIXME: params
@ cdecl _CrtDbgReportW() # FIXME: params
@ cdecl _CrtDoForAllClientObjects() # FIXME: params
@ cdecl _CrtDumpMemoryLeaks() # FIXME: params
@ cdecl _CrtGetAllocHook() # FIXME: params
@ cdecl _CrtGetDebugFillThreshold() # FIXME: params
@ cdecl _CrtGetDumpClient() # FIXME: params
@ cdecl _CrtGetReportHook() # FIXME: params
@ cdecl _CrtIsMemoryBlock() # FIXME: params
@ cdecl _CrtIsValidHeapPointer() # FIXME: params
@ cdecl _CrtIsValidPointer() # FIXME: params
@ cdecl _CrtMemCheckpoint() # FIXME: params
@ cdecl _CrtMemDifference() # FIXME: params
@ cdecl -stub _CrtMemDumpAllObjectsS() # FIXME: paramsince
@ cdecl _CrtMemDumpStatistics() # FIXME: params
@ cdecl _CrtReportBlockType() # FIXME: params
@ cdecl _CrtSetAllocHook() # FIXME: params
@ cdecl _CrtSetBreakAlloc() # FIXME: params
@ cdecl _CrtSetDbgBlockType() # FIXME: params
@ cdecl _CrtSetDbgFlag() # FIXME: params
@ cdecl _CrtSetDebugFillThreshold() # FIXME: params
@ cdecl _CrtSetDumpClient() # FIXME: params
@ cdecl _CrtSetReportFile() # FIXME: params
@ cdecl _CrtSetReportHook() # FIXME: params
@ cdecl _CrtSetReportHook2() # FIXME: params
@ cdecl _CrtSetReportHookW2() # FIXME: params
@ cdecl _CrtSetReportMode() # FIXME: params
...
# @ stub _NLG_Dispatch2 checkme
# @ stub _NLG_Return
# @ stub _NLG_Return2
@ stub _SetWinRTOutOfMemoryExceptionCallback(ptr)
@ cdecl _Strftime(ptr long str ptr ptr)
@ cdecl _VCrtDbgReportA() # FIXME: params
@ cdecl _VCrtDbgReportW() # FIXME: params
@ cdecl _W_Getdays()
@ cdecl _W_Getmonths()
@ cdecl _W_Gettnames()
...
@ stdcall -arch=x86_64,aem,ar64 __C_specific_handler(ptr long ptr ptr) ntdll.__C_specific_handler
...
@ cdecl __conio_common_vcprintf_p() # FIXME: params
@ cdecl __conio_common_vcprintf_s() # FIXME: params
@ cdecl __conio_common_vcscanf() # FIXME: params
@ cdecl __conio_common_vcwprintf(int64 wstr ptr ptr)
@ cdecl __conio_common_vcwprintf_p() # FIXME: params
@ cdecl __conio_common_vcwprintf_s() # FIXME: params
@ cdecl __conio_common_vcwscanf() # FIXME: params
...
@ cdecl -stub -norelay __intrinsic_setjmp(ptr)
@ cdecl -stub -arch=x86_64,arm,arm64 -norelay __intrinsic_setjmpex(ptr ptr)
...
@ cdecl __p__environ()
@ cdecl __p__fmode()
@ cdecl __p__mbcasemap() # FIXME: params
@ cdecl __p__mbctype()
@ cdecl __p__pgmptr()
@ cdecl __p__wcmdln()
@ cdecl __p__wenviron()
...
@ cdecl __report_gsfailure() # FIXME: params
@ cdecl -stub __setusermatherr(ptr)
...
@ cdecl -stub __unDName(ptr str long ptr ptr long)
@ cdecl -stub __unDNameEx(ptr str long ptr ptr ptr long)
@ cdecl -stub __uncaught_exception()
@ cdecl -stub __uncaught_exceptions() # FIXME: params
...
@ cdecl _aligned_offset_recalloc() # FIXME: params
#	_aligned_offset_recalloc_dbg
@ cdecl _aligned_realloc(ptr long long)
#	_aligned_realloc_dbg
@ cdecl _aligned_recalloc() # FIXME: params
...
@ cdecl _cexit()
@ cdecl _cgets(ptr)
@ cdecl _cgets_s() # FIXME: params
@ cdecl _cgetws() # FIXME: params
@ cdecl _cgetws_s() # FIXME: params
@ cdecl _chdir(str)
@ cdecl _chdrive(long)
@ cdecl -stub _chgsign(double)
@ cdecl -stub _chgsignf(float)
@ cdecl -arch=i386 -norelay _chkesp()
@ cdecl _chmod(str long)
@ cdecl _chsize(long long)
@ cdecl _chsize_s(long int64)
@ cdecl _chvalidator() # FIXME: params
@ cdecl _chvalidator_l() # FIXME: params
@ cdecl -stub _clearfp()
@ cdecl _close(long)
@ cdecl _commit(long)
...
@ cdecl -stub _control87(long long)
@ cdecl -stub _controlfp(long long)
@ cdecl -stub _controlfp_s(ptr long long)
@ cdecl -stub _copysign(double double) copysign
@ cdecl -stub _copysignf(float float) copysignf
@ cdecl _cputs(str)
@ cdecl _cputws(wstr)
...
@ cdecl _heapmin()
@ cdecl _heapwalk(ptr)
@ cdecl -stub _hypot(double double)
...
@ cdecl _invalid_parameter() # FIXME: params
@ cdecl _invalid_parameter_noinfo()
@ cdecl _invalid_parameter_noinfo_noreturn()
@ cdecl _invoke_watson() # FIXME: params
@ stub -stub _is_exception_typeof
...
@ cdecl _ismbbalnum_l() # FIXME: params
@ cdecl _ismbbalpha(long)
@ cdecl _ismbbalpha_l() # FIXME: params
@ cdecl _ismbbblank() # FIXME: params
@ cdecl _ismbbblank_l() # FIXME: params
@ cdecl _ismbbgraph(long)
@ cdecl _ismbbgraph_l() # FIXME: params
@ cdecl _ismbbkalnum(long)
@ cdecl _ismbbkalnum_l() # FIXME: params
@ cdecl _ismbbkana(long)
@ cdecl _ismbbkana_l(long ptr)
@ cdecl _ismbbkprint(long)
@ cdecl _ismbbkprint_l() # FIXME: params
@ cdecl _ismbbkpunct(long)
@ cdecl _ismbbkpunct_l() # FIXME: params
@ cdecl _ismbblead(long)
@ cdecl _ismbblead_l(long ptr)
@ cdecl _ismbbprint(long)
@ cdecl _ismbbprint_l() # FIXME: params
@ cdecl _ismbbpunct(long)
@ cdecl _ismbbpunct_l() # FIXME: params
...
@ cdecl _ismbcblank() # FIXME: params
@ cdecl _ismbcblank_l() # FIXME: params
...
@ cdecl _iswcsym_l() # FIXME: params
@ cdecl _iswcsymf_l() # FIXME: params
...
@ cdecl -stub _j0(double)
@ cdecl -stub _j1(double)
@ cdecl -stub _jn(long double)
@ cdecl _kbhit()
@ stub _ld_int
@ cdecl -stub _ldclass(double) # _dclass
@ stub _ldexp
@ stub _ldlog
@ cdecl -stub _ldpcomp(double double) # _dpcomp
@ stub _ldpoly
@ stub _ldscale
@ cdecl -stub _ldsign(double) # _dsign
@ stub _ldsin
@ cdecl -stub _ldtest(ptr) _dtest
@ stub _ldunscale
...
@ cdecl _mbsnbset_s() # FIXME: params
@ cdecl _mbsnbset_s_l() # FIXME: params
@ cdecl _mbsncat(str str long)
@ cdecl _mbsncat_l(str str long ptr)
@ cdecl _mbsncat_s() # FIXME: params
@ cdecl _mbsncat_s_l() # FIXME: params
...
@ cdecl _mbsset_s() # FIXME: params
@ cdecl _mbsset_s_l() # FIXME: params
@ cdecl _mbsspn(str str)
@ cdecl _mbsspn_l(str str ptr)
@ cdecl _mbsspnp(str str)
@ cdecl _mbsspnp_l(str str ptr)
@ cdecl _mbsstr(str str)
@ cdecl _mbsstr_l() # FIXME: params
...
@ cdecl _mbstrnlen() # FIXME: params
@ cdecl _mbstrnlen_l() # FIXME: params
@ cdecl _mbsupr(str)
...
@ cdecl _msize(ptr)
#	_msize_dbg
@ cdecl -stub _nextafter(double double)
@ cdecl -stub -arch=x86_64 _nextafterf(float float)
...
@ cdecl -stub _o___fpe_flt_rounds() __fpe_flt_rounds
...
@ cdecl -stub _o___std_exception_copy(ptr ptr) # __std_exception_copy
@ cdecl -stub _o___std_exception_destroy(ptr) # __std_exception_destroy
@ cdecl -stub _o___std_type_info_destroy_list(ptr) # __std_type_info_destroy_list
@ cdecl -stub _o___std_type_info_name(ptr ptr) # __std_type_info_name
...
@ cdecl -stub _o__cabs(long) _cabs
...
@ cdecl -stub _o__controlfp_s(ptr long long) _controlfp_s
...
@ stub _o__d_int
@ cdecl -stub _o__dclass(double) _dclass
@ cdecl _o__difftime32(long long) _difftime32
@ cdecl _o__difftime64(int64 int64) _difftime64
@ stub _o__dlog
@ stub _o__dnorm
@ cdecl -stub _o__dpcomp(double double) _dpcomp
@ stub _o__dpoly
@ stub _o__dscale
@ cdecl -stub _o__dsign(double) _dsign
@ stub _o__dsin
@ cdecl -stub _o__dtest(ptr) _dtest
@ stub _o__dunscale
...
@ cdecl -stub _o__except1(long long double double long ptr) _except1
...
@ stub _o__fd_int
@ cdecl -stub _o__fdclass(float) _fdclass
@ stub _o__fdexp
@ stub _o__fdlog
@ cdecl -stub _o__fdopen(long str) _fdopen
@ cdecl -stub _o__fdpcomp(float float) _fdpcomp
@ stub _o__fdpoly
@ stub _o__fdscale
@ cdecl -stub _o__fdsign(float) _fdsign
@ stub _o__fdsin
...
@ cdecl -stub _o__fpclass(double) _fpclass
@ cdecl -stub -arch=!i386 _o__fpclassf(float) _fpclassf
...
@ cdecl -stub _o__hypot(double double) _hypot
@ cdecl -stub _o__hypotf(float float) _hypotf
...
@ stub _o__ld_int
@ cdecl -stub _o__ldclass(double) _dclass
@ stub _o__ldexp
@ stub _o__ldlog
...
@ cdecl -stub _o__purecall() _purecall
...
@ cdecl -stub _o__scalb(double long) _scalb
@ cdecl -stub -arch=x86_64 _o__scalbf(float long) _scalbf
...
@ cdecl -stub _o__y0(double) _y0
@ cdecl -stub _o__y1(double) _y1
@ cdecl -stub _o__yn(long double) _yn
@ cdecl _o_abort() abort
@ cdecl -stub _o_acos(double) acos
@ cdecl -stub -arch=!i386 _o_acosf(float) acosf
@ cdecl -stub _o_acosh(double) acosh
@ cdecl -stub _o_acoshf(float) acoshf
@ cdecl -stub _o_acoshl(double) acosh
@ cdecl _o_asctime(ptr) asctime
@ cdecl _o_asctime_s(ptr long ptr) asctime_s
@ cdecl -stub _o_asin(double) asin
@ cdecl -stub -arch=!i386 _o_asinf(float) asinf
@ cdecl -stub _o_asinh(double) asinh
@ cdecl -stub _o_asinhf(float) asinhf
@ cdecl -stub _o_asinhl(double) asinh
@ cdecl -stub _o_atan(double) atan
@ cdecl -stub _o_atan2(double double) atan2
@ cdecl -stub -arch=!i386 _o_atan2f(float float) atan2f
@ cdecl -stub -arch=!i386 _o_atanf(float) atanf
@ cdecl -stub _o_atanh(double) atanh
@ cdecl -stub _o_atanhf(float) atanhf
@ cdecl -stub _o_atanhl(double) atanh
...
@ cdecl -stub _o_cbrt(double) cbrt
@ cdecl -stub _o_cbrtf(float) cbrtf
...
@ cdecl -stub _o_cos(double) cos
@ cdecl -stub -arch=!i386 _o_cosf(float) cosf
@ cdecl -stub _o_cosh(double) cosh
@ cdecl -stub -arch=!i386 _o_coshf(float) coshf
@ cdecl -stub _o_erf(double) erf
@ cdecl -stub _o_erfc(double) erfc
@ cdecl -stub _o_erfcf(float) erfcf
@ cdecl -stub _o_erfcl(double) erfc
@ cdecl -stub _o_erff(float) erff
@ cdecl -stub _o_erfl(double) erf
@ cdecl -stub _o_exit(long) exit
@ cdecl -stub _o_exp(double) exp
@ cdecl -stub _o_exp2(double) exp2
@ cdecl -stub _o_exp2f(float) exp2f
@ cdecl -stub _o_exp2l(double) exp2
@ cdecl -stub -arch=!i386 _o_expf(float) expf
@ cdecl -stub _o_fabs(double) fabs
...
@ cdecl -stub _o_floor(double) floor
@ cdecl -stub -arch=!i386 _o_floorf(float) floorf
@ cdecl -stub _o_fma(double double double) fma
@ cdecl -stub _o_fmaf(float float float) fmaf
@ cdecl -stub _o_fmal(double double double) fma
@ cdecl -stub _o_fmod(double double) fmod
@ cdecl -stub -arch=!i386 _o_fmodf(float float) fmodf
...
@ cdecl -stub _o_frexp(double ptr) frexp
...
@ cdecl -stub _o_ldexp(double long) ldexp
@ cdecl -stub _o_lgamma(double) lgamma
@ cdecl -stub _o_lgammaf(float) lgammaf
@ cdecl -stub _o_lgammal(double) lgamma
@ cdecl -stub -ret64 _o_llrint(double) llrint
@ cdecl -stub -ret64 _o_llrintf(float) llrintf
@ cdecl -stub -ret64 _o_llrintl(double) llrint
@ cdecl -stub -ret64 _o_llround(double) llround
@ cdecl -stub -ret64 _o_llroundf(float) llroundf
@ cdecl -stub -ret64 _o_llroundl(double) llround
@ cdecl _o_localeconv() localeconv
@ cdecl -stub _o_log(double) log
@ cdecl _o_log10(double) log10
@ cdecl -arch=!i386 _o_log10f(float) log10f
@ cdecl -stub _o_log1p(double) log1p
@ cdecl -stub _o_log1pf(float) log1pf
@ cdecl -stub _o_log1pl(double) log1p
@ cdecl -stub _o_log2(double) log2
@ cdecl -stub _o_log2f(float) log2f
@ cdecl -stub _o_log2l(double) log2
@ cdecl -stub _o_logb(double) logb
@ cdecl -stub _o_logbf(float) logbf
@ cdecl -stub _o_logbl(double) logb
@ cdecl -stub -arch=!i386 _o_logf(float) logf
@ cdecl -stub _o_lrint(double) lrint
@ cdecl -stub _o_lrintf(float) lrintf
@ cdecl -stub _o_lrintl(double) lrint
@ cdecl -stub _o_lround(double) lround
@ cdecl -stub _o_lroundf(float) lroundf
@ cdecl -stub _o_lroundl(double) lround
...
@ cdecl -stub _o_modf(double ptr) modf
@ cdecl -stub -arch=!i386 _o_modff(float ptr) modff
@ cdecl -stub _o_nan(str) nan
@ cdecl -stub _o_nanf(str) nanf
@ cdecl -stub _o_nanl(str) nan
@ cdecl -stub _o_nearbyint(double) nearbyint
@ cdecl -stub _o_nearbyintf(float) nearbyintf
@ cdecl -stub _o_nearbyintl(double) nearbyint
@ cdecl -stub _o_nextafter(double double) nextafter
@ cdecl -stub _o_nextafterf(float float) nextafterf
@ cdecl -stub _o_nextafterl(double double) nextafter
@ cdecl -stub _o_nexttoward(double double) nexttoward
@ cdecl -stub _o_nexttowardf(float double) nexttowardf
@ cdecl -stub _o_nexttowardl(double double) nexttoward
@ cdecl -stub _o_pow(double double) pow
@ cdecl -stub -arch=!i386 _o_powf(float float) powf
...
@ cdecl -stub _o_remainder(double double) remainder
@ cdecl -stub _o_remainderf(float float) remainderf
@ cdecl -stub _o_remainderl(double double) remainder
@ cdecl _o_remove(str) remove
@ cdecl -stub _o_remquo(double double ptr) remquo
@ cdecl -stub _o_remquof(float float ptr) remquof
@ cdecl -stub _o_remquol(double double ptr) remquo
@ cdecl _o_rename(str str) rename
@ cdecl _o_rewind(ptr) rewind
@ cdecl -stub _o_rint(double) rint
@ cdecl -stub _o_rintf(float) rintf
@ cdecl -stub _o_rintl(double) rint
@ cdecl -stub _o_round(double) round
@ cdecl -stub _o_roundf(float) roundf
@ cdecl -stub _o_roundl(double) round
@ cdecl -stub _o_scalbln(double long) _scalb
@ cdecl -stub _o_scalblnf(float long) _scalbf
@ cdecl -stub _o_scalblnl(double long) _scalb
@ cdecl -stub _o_scalbn(double long) _scalb
@ cdecl -stub _o_scalbnf(float long) _scalbf
@ cdecl -stub _o_scalbnl(double long) _scalb
...
@ cdecl -stub _o_sin(double) sin
@ cdecl -stub -arch=!i386 _o_sinf(float) sinf
@ cdecl -stub _o_sinh(double) sinh
@ cdecl -stub -arch=!i386 _o_sinhf(float) sinhf
@ cdecl -stub _o_sqrt(double) sqrt
@ cdecl -stub -arch=!i386 _o_sqrtf(float) sqrtf
...
@ cdecl _putws(wstr)
@ cdecl _query_app_type() # FIXME: params
...
@ cdecl -stub _scalb(double long)
@ cdecl -stub -arch=x86_64 _scalbf(float long)
...
@ cdecl -stub -arch=win64 _set_FMA3_enable(long)
...
@ cdecl -stub _set_controlfp(long long)
...
@ cdecl -stub -arch=i386 -norelay _setjmp3(ptr long)
...
@ cdecl _strerror_s() # FIXME: params
...
@ cdecl -stub _strnset(str long long)
@ cdecl _strnset_s(str long long long)
@ cdecl -stub _strrev(str)
@ cdecl _strset(str long)
@ cdecl _strset_s() # FIXME: params
@ cdecl _strtime(ptr)
...
@ cdecl _wcstoimax_l() # FIXME: params
...
@ cdecl _wcstoumax_l() # FIXME: params
@ cdecl _wcsupr(wstr)
...
@ cdecl -stub _y0(double)
@ cdecl -stub _y1(double)
@ cdecl -stub _yn(long double)
@ cdecl abort()
@ cdecl abs(long)
@ cdecl -stub acos(double)
@ cdecl -stub -arch=!i386 acosf(float)
@ cdecl -stub acosh(double)
@ cdecl -stub acoshf(float)
@ cdecl -stub acoshl(double)
@ cdecl asctime(ptr)
@ cdecl asctime_s(ptr long ptr)
@ cdecl -stub asin(double)
@ cdecl -stub -arch=!i386 asinf(float)
@ cdecl -stub asinh(double)
@ cdecl -stub asinhf(float)
@ cdecl -stub asinhl(double) asinh
@ cdecl -stub atan(double)
@ cdecl -stub atan2(double double)
@ cdecl -stub -arch=!i386 atan2f(float float)
@ cdecl -stub -arch=!i386 atanf(float)
...
@ cdecl btowc(long)
@ cdecl c16rtomb() # FIXME: params
@ cdecl c32rtomb() # FIXME: params
@ stub cabs
@ stub cabsf
@ stub cabsl
@ stub cacos
...
@ cdecl -stub cos(double)
@ cdecl -stub -arch=!i386 cosf(float)
@ cdecl -stub cosh(double)
@ cdecl -stub -arch=!i386 coshf(float)
@ stub cpow
@ stub cpowf
@ stub cpowl
@ stub cproj
...
@ cdecl exit(long)
@ cdecl -stub exp(double)
@ cdecl -stub exp2(double)
@ cdecl -stub exp2f(float)
@ cdecl -stub exp2l(double) exp2
@ cdecl -stub -arch=!i386 expf(float)
@ cdecl -stub expm1(double)
@ cdecl -stub expm1f(float)
@ cdecl -stub expm1l(double) expm1
@ cdecl -stub fabs(double)
@ cdecl -stub -arch=arm,arm64 fabsf(float)
@ cdecl fclose(ptr)
@ cdecl -stub fdim(double double)
@ cdecl -stub fdimf(float float)
@ cdecl -stub fdiml(double double) fdim
...
@ cdecl -stub floor(double)
@ cdecl -stub -arch=!i386 floorf(float)
@ cdecl -stub fma(double double double)
@ cdecl -stub fmaf(float float float)
@ cdecl -stub fmal(double double double) fma
@ cdecl -stub fmax(double double)
@ cdecl -stub fmaxf(float float)
@ cdecl -stub fmaxl(double double) fmax
@ cdecl -stub fmin(double double)
@ cdecl -stub fminf(float float)
@ cdecl -stub fminl(double double) fmin
@ cdecl -stub fmod(double double)
@ cdecl -stub -arch=!i386 fmodf(float float)
@ cdecl fopen(str str)
...
@ cdecl getwc(ptr)
@ cdecl getwchar()
@ cdecl -stub hypot(double double) _hypot
@ cdecl -stub ilogb(double)
@ cdecl -stub ilogbf(float)
@ cdecl -stub ilogbl(double) ilogb
@ cdecl -stub -ret64 imaxabs(int64)
@ stub imaxdiv
...
@ cdecl isxdigit(long)
@ cdecl -stub labs(long)
@ cdecl -stub ldexp(double long)
@ cdecl -stub -ret64 ldiv(long long)
@ cdecl -stub lgamma(double)
@ cdecl -stub lgammaf(float)
@ cdecl -stub lgammal(double) lgamma
@ cdecl -stub -ret64 llabs(int64)
@ cdecl -stub -norelay lldiv(int64 int64)
@ cdecl -stub -ret64 llrint(double)
@ cdecl -stub -ret64 llrintf(float)
@ cdecl -stub -ret64 llrintl(double) llrint
@ cdecl -stub -ret64 llround(double)
@ cdecl -stub -ret64 llroundf(float)
@ cdecl -stub -ret64 llroundl(double) llround
@ cdecl localeconv()
@ cdecl -stub log(double)
@ cdecl log10(double)
@ cdecl -arch=!i386 log10f(float)
@ cdecl -stub log1p(double)
@ cdecl -stub log1pf(float)
@ cdecl -stub log1pl(double) log1p
@ cdecl -stub log2(double)
@ cdecl -stub log2f(float)
@ cdecl -stub log2l(double) log2
@ cdecl -stub logb(double)
@ cdecl -stub logbf(float)
@ cdecl -stub logbl(double) logb
@ cdecl -stub -arch=!i386 logf(float)
@ cdecl -stub longjmp(ptr long)
@ cdecl -stub lrint(double)
@ cdecl -stub lrintf(float)
@ cdecl -stub lrintl(double) lrint
@ cdecl -stub lround(double)
@ cdecl -stub lroundf(float)
@ cdecl -stub lroundl(double) lround
@ cdecl malloc(long)
@ cdecl mblen(ptr long)
@ cdecl mbrlen(ptr long ptr)
@ cdecl mbrtoc16() # FIXME: params
@ cdecl mbrtoc32() # FIXME: params
...
@ cdecl -stub remainderl(double double) remainder
@ cdecl remove(str)
@ cdecl -stub remquo(double double ptr)
@ cdecl -stub remquof(float float ptr)
@ cdecl -stub remquol(double double ptr) remquo
@ cdecl rename(str str)
@ cdecl -arch=!i386 rewind(ptr) # -arch=i386 rewind(ptr) rewind_preserve_stack?
@ cdecl -stub rint(double)
@ cdecl -stub rintf(float)
@ cdecl -stub rintl(double)
@ cdecl -stub round(double)
@ cdecl -stub roundf(float)
@ cdecl -stub roundl(double) round
@ cdecl -stub scalbln(double long) _scalb
@ cdecl -stub scalblnf(float long) _scalbf
@ cdecl -stub scalblnl(double long) _scalb
@ cdecl -stub scalbn(double long) _scalb
@ cdecl -stub scalbnf(float long) _scalbf
@ cdecl -stub scalbnl(double long) _scalb
@ cdecl set_terminate(ptr)
@ cdecl -stub set_unexpected(ptr)
@ cdecl setbuf(ptr ptr)
@ cdecl -stub -arch=arm,x86_64 -norelay -private setjmp(ptr)
@ cdecl setlocale(long str)
@ cdecl setvbuf(ptr str long long)
@ cdecl signal(long long)
@ cdecl -stub sin(double)
@ cdecl -stub -arch=!i386 sinf(float)
@ cdecl -stub sinh(double)
@ cdecl -stub -arch=!i386 sinhf(float)
@ cdecl -stub sqrt(double)
@ cdecl -stub -arch=!i386 sqrtf(float)
@ cdecl srand(long)
...
@ cdecl system(str)
@ cdecl -stub tan(double)
@ cdecl -stub -arch=!i386 tanf(float)
@ cdecl -stub tanh(double)
@ cdecl -stub -arch=!i386 tanhf(float)
@ cdecl terminate()
@ cdecl -stub tgamma(double)
@ cdecl -stub tgammaf(float)
@ cdecl -stub tgammal(double) tgamma
@ cdecl tmpfile()
@ cdecl tmpfile_s(ptr)
@ cdecl tmpnam(ptr)
...
@ cdecl -stub truncl(double) trunc
@ stub unexpected
