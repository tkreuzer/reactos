...
#endif
inline wstring to_wstring(uint8_t a) { WCHAR buffer[16]; _swprintf(buffer, L"%d", a); return wstring(buffer); }
inline wstring to_wstring(uint16_t a) { WCHAR buffer[16]; _swprintf(buffer, L"%d", a); return wstring(buffer); }
inline wstring to_wstring(uint32_t a) { WCHAR buffer[32]; _swprintf(buffer, L"%ld", a); return wstring(buffer); }
inline wstring to_wstring(uint64_t a) { WCHAR buffer[64]; _swprintf(buffer, L"%I64d", a); return wstring(buffer); }
#endif
