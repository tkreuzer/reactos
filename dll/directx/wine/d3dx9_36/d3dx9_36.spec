...
@ stdcall D3DXCheckCubeTextureRequirements(ptr ptr ptr long ptr long)
@ stdcall D3DXCheckTextureRequirements(ptr ptr ptr ptr long ptr long)
@ stdcall D3DXCheckVersion(long long)
@ stdcall D3DXCheckVolumeTextureRequirements(ptr ptr ptr ptr ptr long ptr long)
...
@ stdcall D3DXCreateEffectCompilerFromResourceA(ptr str ptr ptr long ptr ptr)
@ stdcall D3DXCreateEffectCompilerFromResourceW(ptr wstr ptr ptr long ptr ptr)
...
@ stdcall D3DXCreateEffectFromResourceA(ptr ptr str ptr ptr long ptr ptr ptr)
@ stdcall D3DXCreateEffectFromResourceExA(ptr ptr str ptr ptr str long ptr ptr ptr)
@ stdcall D3DXCreateEffectFromResourceExW(ptr ptr wstr ptr ptr str long ptr ptr ptr)
@ stdcall D3DXCreateEffectFromResourceW(ptr ptr wstr ptr ptr long ptr ptr ptr)
...
@ stdcall D3DXCreateTextA(ptr ptr str float float ptr ptr ptr)
@ stdcall D3DXCreateTextW(ptr ptr wstr float float ptr ptr ptr)
...
@ stdcall D3DXLoadMeshFromXResource(ptr str str long ptr ptr ptr ptr ptr ptr)
